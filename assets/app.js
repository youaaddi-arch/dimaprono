...
let COMMENTS = [];          // commentaires du chat (partagés)
let chatPrefill = "";       // texte pré-rempli (ex: mention depuis le podium)
...
(async function initSync() {
  ...
  // Écran de fête (une fois par session) si la partie existe déjà.
  else if (S.players.length && !sessionStorage.getItem("dimaprono_splash")) {
    sessionStorage.setItem("dimaprono_splash", "1");
